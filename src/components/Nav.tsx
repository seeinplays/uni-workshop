...
function Nav() {
  ...
  return (
    <>
      ...
      >
        <Flex align='center'>
          <Image boxSize='50' mr={5} src={process.env.PUBLIC_URL + '/imgs/polywrap.png'} alt='Polywrap Logo' />
        ...
        <Flex align='center'>
          ...
          {active ?
            <Button borderRadius='15px' colorScheme='green' onClick={() => deactivate() }>
              ✅ {account?.substr(0, 6)}...
            </Button> :
            <Button borderRadius='15px' colorScheme='green' onClick={() => {
